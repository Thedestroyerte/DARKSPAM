...
PythonHelp = f"⚡️ ​4𝗦𝗧 𝗗𝗔𝗥𝗞 𝗦𝗣𝗔𝗠 𝗛𝗘𝗟𝗣 𝗠𝗘𝗡𝗨 ⚡️\n\n» **ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴꜱ ꜰᴏʀ ʜᴇʟᴘ**\n» **ᴅᴇᴠᴇʟᴏᴘᴇʀ: @DARK_4ST**"
...
async def help(event):
    if event.sender_id in SUDO_USERS:
       await event.client.send_file(event.chat_id,
                               "https://telegra.ph/file/05f8f96339581698c90ce.jpg",
                                  caption=PythonHelp,
                                  buttons=[
           [
           ...
           [    
            Button.url("⚡️ ᴄʜᴀɴɴᴇʟ ⚡️", "https://t.me/+mDjKa2gljxpmZTZl"),
            Button.url("⚡️ sᴜᴘᴘᴏʀᴛ ⚡️", "https://t.me/+OIdiORhDWLwzNGE1")
           ],
           ],
           )
...
async def helpback(event):
   if event.query.user_id in SUDO_USERS:    
      await event.edit(
        ...
        await event.answer("𝗣ᴀʜʟᴇ 𝗝ᴀᴀᴋᴇ 𝗣ᴀᴘᴀ 𝗕ᴏʟ ⚡️𝗗𝗔𝗥𝗞⚡️ 𝗞ᴏ 𝗪ᴏ 𝗧ᴜᴍʜᴇ 𝗦ᴜᴅᴏ 𝗗ᴇ 𝗗ᴇɢᴀ", cache_time=0, alert=True)
