  ...
  if event.sender_id in SUDO_USERS:
     if event.reply_to_msg_id is not None:
        ...
        if int(user_id) in ALTRON:
            await event.reply("» ᴀʀᴇ.. ʏᴇ ᴛᴏ ᴛᴇʀᴀ ᴅᴀʀᴋ ᴘᴀᴘᴀ ʜᴀɪ", parse_mode=None, link_preview=None)
        elif int(user_id) == OWNER_ID:
            await event.reply("» ᴀʀᴇ.. ʏᴇ ᴛᴏ ᴛᴇʀᴀ ᴅᴀʀᴋ ʙᴀᴀᴘ ʜᴀɪ", parse_mode=None, link_preview=None)
        elif int(user_id) in SUDO_USERS:
            await event.reply("» ᴀʙᴇ.. ɪs ᴄʜᴜᴛɪʏᴇ ᴋᴇ ᴘᴀᴀs ᴘᴇʜʟᴇ sᴇ sᴜᴅᴏ ʜᴀɪ", parse_mode=None, link_preview=None)
        else:
